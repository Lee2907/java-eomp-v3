function viewProfile() {
  ...
  fetch(
    `https://lee-buka2907.herokuapp.com/view-profile/${window.localStorage[
      "username"]
    }/`,
    {
      method: "GET",
      ...
      console.log(user);
        document.querySelector(
          ".profile-container"
                            ...
                            <p class="user-number">Phone No.: ${user[5]}</p>
                            <p class="user-email">Email: ${user[6]}</p>
                            <p class="profile-username">Username: ${user[3]}</p>
                            <p class="profile-password">Password: ${user[4]}</p>
...
function saveEditedProfile() {
  fetch(
    `https://lee-buka2907.herokuapp.com/edit-profile/${window.localStorage["user-id"]}/`,
    {
      method: "PUT",
      body: JSON.stringify ({
...
function deleteProfile() {
  fetch(
    `https://lee-buka2907.herokuapp.com/delete-profile/${window.localStorage["user-id"]}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
function editProduct() {
  ...
  fetch(`https://lee-buka2907.herokuapp.com/edit-product/${parseInt(document.querySelector(".edit-product").id)}/`, {
    method: "PUT", 
    body: JSON.stringify ({
...
function viewUsersProducts() {
  fetch(`https://lee-buka2907.herokuapp.com/orders/${window.localStorage["user_id"]}/`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `jwt ${window.localStorage["jwt-token"]}`,
...
function deleteProduct(product_id) {
  fetch(`https://lee-buka2907.herokuapp.com/delete-product/${product_id}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      "Access-Control-Allow-Origin": "*",
